...
from .command_vttforge_extensions import VTTFORGE_COMMAND_EXTENSION_SPECS, VTTFORGE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (VTTFORGE_COMMAND_EXTENSION_SPECS, VTTFORGE_COMMAND_RULES),
)
