...
| `command.mcp-quidli-connect` | Reviews value-moving, paid, and onchain trust-write tools for the official hosted Quidli Connect MCP server. | 0 | External opt-in |
