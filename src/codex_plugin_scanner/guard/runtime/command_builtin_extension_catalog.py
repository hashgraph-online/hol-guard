...
from .command_macscope_extensions import MACSCOPE_COMMAND_EXTENSION_SPECS, MACSCOPE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (MACSCOPE_COMMAND_EXTENSION_SPECS, MACSCOPE_COMMAND_RULES),
