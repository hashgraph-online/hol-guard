...
| `command.formicx` | Reviews Formicx mutation lifecycle commands (register, start, stop, restart) while leaving read-only queries (list, status, resources) automatic. | 4 | External opt-in |
