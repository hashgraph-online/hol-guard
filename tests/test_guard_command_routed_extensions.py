...
ROUTED_REVIEW_CASES: tuple[tuple[str, str, str], ...] = (
    ...
    ("routed doctor --fix --help", _DOCTOR_FIX_ACTION, "command.routed.doctor-fix"),
    ("routed doctor --fix -h", _DOCTOR_FIX_ACTION, "command.routed.doctor-fix"),
    ("routed adapters install --help", _ADAPTER_ACTION, "command.routed.adapters-install"),
    ("routed adapters install -h", _ADAPTER_ACTION, "command.routed.adapters-install"),
    ("routed adapters uninstall --help", _ADAPTER_ACTION, "command.routed.adapters-uninstall"),
    ("routed adapters uninstall -h", _ADAPTER_ACTION, "command.routed.adapters-uninstall"),
    ("routed update --help", _UPDATE_ACTION, "command.routed.update"),
    ("routed update -h", _UPDATE_ACTION, "command.routed.update"),
    ("routed upgrade --help", _UPDATE_ACTION, "command.routed.update"),
    ("routed upgrade -h", _UPDATE_ACTION, "command.routed.update"),
