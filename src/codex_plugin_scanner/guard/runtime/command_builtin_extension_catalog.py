...
from .command_codesage_extensions import CODESAGE_COMMAND_EXTENSION_SPECS, CODESAGE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (CODESAGE_COMMAND_EXTENSION_SPECS, CODESAGE_COMMAND_RULES),
)
