import { r as reactExports, j as jsxRuntimeExports, H as HiMiniShieldCheck, a as HiMiniExclamationTriangle, b as HiMiniInformationCircle, S as SectionLabel, f as formatRelativeTime, A as ActionButton, c as HiMiniArrowRight, T as Tag, d as HiMiniCheckCircle, e as HiMiniXCircle, h as harnessDisplayName, i as isDisplayableHarness, E as EmptyState, G as GuardHero, P as ProofStrip, g as formatNumber, k as HiMiniSparkles, l as HiMiniXMark, m as HiMiniChevronUp, n as HiMiniChevronDown, o as HiMiniCloud, p as HiMiniQuestionMarkCircle, q as HiMiniBolt, B as Badge, s as HiMiniChevronRight, t as HiMiniMinusCircle } from "../guard-dashboard.js";
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 space-y-3", children: [
          ...
          hasManagers && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          lastBlocked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-brand-attention/15 bg-brand-attention/[0.04] px-3 py-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-brand-attention uppercase tracking-[0.15em]", children: "Last blocked install" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-brand-dark", children: lastBlocked.harness }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: formatRelativeTime(lastBlocked.updated_at) })
          ] }),
          ...
          (status === "unprotected" || status === "unknown") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 mb-3", children: "Set up Guard on your AI apps to enable package manager protection." }),
          ...
          onOpenSupplyChain && status !== "unknown" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
