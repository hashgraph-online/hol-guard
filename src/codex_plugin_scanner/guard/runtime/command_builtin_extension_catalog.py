...
from .command_agentburp_extensions import AGENTBURP_COMMAND_EXTENSION_SPECS, AGENTBURP_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (AGENTBURP_COMMAND_EXTENSION_SPECS, AGENTBURP_COMMAND_RULES),
)
