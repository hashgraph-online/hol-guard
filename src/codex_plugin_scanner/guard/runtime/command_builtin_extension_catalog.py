...
from .command_repro_surgeon_extensions import REPRO_SURGEON_COMMAND_EXTENSION_SPECS, REPRO_SURGEON_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (REPRO_SURGEON_COMMAND_EXTENSION_SPECS, REPRO_SURGEON_COMMAND_RULES),
)
