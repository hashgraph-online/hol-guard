...
from .command_codex_migrate_extensions import CODEX_MIGRATE_COMMAND_EXTENSION_SPECS, CODEX_MIGRATE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (CODEX_MIGRATE_COMMAND_EXTENSION_SPECS, CODEX_MIGRATE_COMMAND_RULES),
