...
from .command_tui_runner_extensions import TUI_RUNNER_COMMAND_EXTENSION_SPECS, TUI_RUNNER_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (TUI_RUNNER_COMMAND_EXTENSION_SPECS, TUI_RUNNER_COMMAND_RULES),
)
