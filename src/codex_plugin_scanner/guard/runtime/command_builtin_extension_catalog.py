...
from .command_shellroute_extensions import SHELLROUTE_COMMAND_EXTENSION_SPECS, SHELLROUTE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (SHELLROUTE_COMMAND_EXTENSION_SPECS, SHELLROUTE_COMMAND_RULES),
)
