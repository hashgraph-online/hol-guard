...
@pytest.mark.parametrize(
    ...
    (
        ...
        (("pr", "merge", "123", "--squash", "--delete-branch=false"), ("routine_merge_remote",)),
        (("pr", "merge", "123", "--squash", "--delete-branch=true"), ("routine_merge_remote",)),
        (("pr", "merge", "123", "--delete-branch=false"), ("merge_remote",)),
        (("pr", "merge", "123", "--admin", "--delete-branch=false"), ("admin_merge_remote",)),
        (("pr", "merge", "123", "--delete-branch=maybe"), ("unknown",)),
        (("pr", "merge", "123", "--squash", "--delete-branch=maybe"), ("unknown",)),
