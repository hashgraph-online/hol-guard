...
- Promotion means merge into `release/3.0` plus alpha artifact verification. Integration into `main`, stable PyPI publication, and default runtime activation remain separate decisions.
