...
_COMPONENTS = (
    (
        "guard-rules",
        Path("rust/crates/guard-rules/src/lib.rs"),
    ),
    (
        "guard-scanner",
        Path("rust/crates/guard-scanner/src/lib.rs"),
    ),
    (
        "guard-secure-fs",
        Path("rust/crates/guard-secure-fs/src/lib.rs"),
    ),
    (
        "guard-hook-core",
        Path("rust/crates/guard-hook-core/src/lib.rs"),
    ),
    (
        "guard-contracts",
        Path("rust/crates/guard-contracts/src/lib.rs"),
    ),
    (
        "guard-command-pretool",
        Path("rust/crates/guard-command/src/pretool.rs"),
    ),
    (
        "guard-command-pretool-generic",
        Path("rust/crates/guard-command/src/pretool/generic.rs"),
    ),
    (
        "guard-command-pretool-result",
        Path("rust/crates/guard-command/src/pretool/generic_result.rs"),
    ),
    (
        "guard-command-pretool-extract",
        Path("rust/crates/guard-command/src/pretool/generic_extract.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-policy-snapshot/src/lib.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_argument_semantics.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_common_cli_matchers.rs"),
    ),
    (
        "guard-command-command-curl-operations",
        Path("rust/crates/guard-command/src/command_curl_operations.rs"),
    ),
    (
        "guard-command-command-curl-targets",
        Path("rust/crates/guard-command/src/command_curl_targets.rs"),
    ),
    (
        "guard-command-command-database-matchers",
        Path("rust/crates/guard-command/src/command_database_matchers.rs"),
    ),
    (
        "guard-command-command-operand-matchers",
        Path("rust/crates/guard-command/src/command_operand_matchers.rs"),
    ),
    (
        "guard-command-command-option-parsing",
        Path("rust/crates/guard-command/src/command_option_parsing.rs"),
    ),
    (
        "guard-command-command-option-unicode",
        Path("rust/crates/guard-command/src/command_option_unicode.rs"),
    ),
    (
        "guard-command-command-reviewed-literal",
        Path("rust/crates/guard-command/src/command_reviewed_literal.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_structured_matchers.rs"),
    ),
    (
        "guard-command-executable-flag-contract",
        Path("rust/crates/guard-command/src/executable_flag_contract.rs"),
    ),
    (
        "guard-command-lib",
    ...
    (
        ...
        Path("rust/crates/guard-command/src/native_command_program.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/native_command_program_wire.rs"),
    ),
    (
        "guard-command-pretool-search-glob-class",
        Path("rust/crates/guard-command/src/pretool/search/glob_class.rs"),
    ),
    (
        "guard-command-pretool-search-hint",
        Path("rust/crates/guard-command/src/pretool/search/hint.rs"),
    ),
    (
        "guard-command-pretool-search-options",
        Path("rust/crates/guard-command/src/pretool/search/options.rs"),
    ),
    (
        "guard-command-pretool-search",
        Path("rust/crates/guard-command/src/pretool/search.rs"),
    ),
    (
        "guard-contracts-native-command-controls",
        Path("rust/crates/guard-contracts/src/native_command_controls.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_ascii_comparison.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_compatibility/git.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-command/src/command_compatibility.rs"),
    ),
    (
    ...
    (
        ...
        Path("rust/crates/guard-runtime/src/policy_store_persistence.rs"),
    ),
    (
        "guard-runtime-native-hook-receipt",
        Path("rust/crates/guard-runtime/src/native_hook_receipt.rs"),
    ),
    (
        "guard-runtime-edge",
