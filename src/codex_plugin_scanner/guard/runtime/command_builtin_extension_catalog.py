...
from .command_blitcp_extensions import BLITCP_COMMAND_EXTENSION_SPECS, BLITCP_COMMAND_RULES
...
from .command_errand_extensions import ERRAND_COMMAND_EXTENSION_SPECS, ERRAND_COMMAND_RULES
...
from .command_ollama_extensions import OLLAMA_COMMAND_EXTENSION_SPECS, OLLAMA_COMMAND_RULES
...
from .command_syngraphe_extensions import SYNGRAPHE_COMMAND_EXTENSION_SPECS, SYNGRAPHE_COMMAND_RULES

_DIRECT_EXTENSION_CATALOGS = (
    (ERRAND_COMMAND_EXTENSION_SPECS, ERRAND_COMMAND_RULES),
    (DOMAIN_COMMAND_EXTENSION_SPECS, DOMAIN_COMMAND_RULES),
    (FRAMEWORK_COMMAND_EXTENSION_SPECS, FRAMEWORK_COMMAND_RULES),
    (CLOUD_COMMAND_EXTENSION_SPECS, CLOUD_COMMAND_RULES),
    (DNS_COMMAND_EXTENSION_SPECS, DNS_COMMAND_RULES),
    ...
    (BLITCP_COMMAND_EXTENSION_SPECS, BLITCP_COMMAND_RULES),
    ...
    (OLLAMA_COMMAND_EXTENSION_SPECS, OLLAMA_COMMAND_RULES),
    (PROBE_COMMAND_EXTENSION_SPECS, PROBE_COMMAND_RULES),
    (SKILL_SUNSET_COMMAND_EXTENSION_SPECS, SKILL_SUNSET_COMMAND_RULES),
    (GITHUB_COMMAND_EXTENSION_SPECS, GITHUB_COMMAND_RULES),
    (REPO2NB_COMMAND_EXTENSION_SPECS, REPO2NB_COMMAND_RULES),
    (SYNGRAPHE_COMMAND_EXTENSION_SPECS, SYNGRAPHE_COMMAND_RULES),
)
