...
| `command.synapsectrl` | Reviews SynapseCTRL commands that change the active Razer Synapse profile or modify the persistent Synapse launch hook. | 2 | External opt-in |
