...
from .command_flashpilot_extensions import FLASHPILOT_COMMAND_EXTENSION_SPECS, FLASHPILOT_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (FLASHPILOT_COMMAND_EXTENSION_SPECS, FLASHPILOT_COMMAND_RULES),
)
