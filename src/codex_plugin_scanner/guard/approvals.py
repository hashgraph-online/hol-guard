...
from .policy_memory_source import request_policy_memory_envelope
from .protection_capabilities import protection_capability_payloads
from .redaction import redact_text
from .review_request_display import (
    _is_generic_tool_label as _is_generic_tool_label,
)
from .review_request_display import (
    _item_action_envelope_json,
    _review_action_text_from_item,
)
from .review_request_display import (
    _review_action_text_from_envelope as _review_action_text_from_envelope,
)
    ...
    *,
    ...
    for item in artifacts:
        ...
        request = GuardApprovalRequest(
            ...
            action_envelope_json=request_policy_memory_envelope(
                store,
                item=item,
                envelope=canonical_decision.action_envelope_json,
                request_id=request_id,
                artifact_id=artifact_id,
                harness=detection.harness,
                now=timestamp,
