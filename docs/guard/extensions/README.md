...
| `command.givi` | Opt-in review of six direct givi CLI operations affecting automatic review and finding decisions. Does not cover MCP calls, npm/Node wrappers, other submissions or all GiviLoop writes. | 6 | External opt-in |
