...
@pytest.mark.parametrize(
    ...
    (
        ...
        ["get", "pod/worker-0", "pod/worker-1", "-o", "name"],
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "kubectl get pod/worker-0 secret/service-token -o name",
        ...
        "kubectl get pods --watch -o name",
        "kubectl get pods --watch-only -o name",
        "kubectl get pods -w -o name",
