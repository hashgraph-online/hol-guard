...
from .command_agi_memory_extensions import AGI_MEMORY_COMMAND_EXTENSION_SPECS, AGI_MEMORY_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (AGI_MEMORY_COMMAND_EXTENSION_SPECS, AGI_MEMORY_COMMAND_RULES),
)
