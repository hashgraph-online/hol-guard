...
from .command_librarybridge_extensions import LIBRARYBRIDGE_COMMAND_EXTENSION_SPECS, LIBRARYBRIDGE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (LIBRARYBRIDGE_COMMAND_EXTENSION_SPECS, LIBRARYBRIDGE_COMMAND_RULES),
