...
CLOUD_COMMAND_EXTENSION_SPECS = (
    CommandExtensionSpec(
        ...
        description=(
            "Reviews a validated AWS CLI operation matrix for permanent resource deletion and service termination across identity, compute, data, delivery, and control-plane services."
        ),
