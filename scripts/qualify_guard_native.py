...
from scripts.native_slo_corpus_identity import paired_corpus_identity  # noqa: E402
...
def _run_pair(args: argparse.Namespace) -> dict[str, object]:
    ...
    corpus_comparison = paired_corpus_identity(reports["baseline"], reports["candidate"])
