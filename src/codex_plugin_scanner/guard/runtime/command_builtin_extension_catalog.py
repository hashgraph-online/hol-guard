...
from .command_keibidrop_extensions import KEIBIDROP_COMMAND_EXTENSION_SPECS, KEIBIDROP_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (KEIBIDROP_COMMAND_EXTENSION_SPECS, KEIBIDROP_COMMAND_RULES),
)
