...
def _reviewed_types() -> dict[type[object], str]:
    ...
    from .command_common_cli_matchers_extra import (
        AnsibleExecutionMatcher,
        DotnetPositionalProjectPackageMatcher,
        MongoEvalMutationMatcher,
        OpenShiftDeleteDrainMatcher,
        OpenShiftMutationMatcher,
        SqliteMutationMatcher,
        SqlOptionMutationMatcher,
    )
    ...
    return {
        ...
        AnsibleExecutionMatcher: "ansible-execution.v1",
        SqlOptionMutationMatcher: "sql-option-mutation.v1",
        DotnetPositionalProjectPackageMatcher: "dotnet-project-package.v1",
        MongoEvalMutationMatcher: "mongo-eval-mutation.v1",
        SqliteMutationMatcher: "sqlite-mutation.v1",
        OpenShiftDeleteDrainMatcher: "openshift-delete-drain.v1",
        OpenShiftMutationMatcher: "openshift-mutation.v1",
    }
