...
| `command.librarybridge` | Reviews LibraryBridge commands that move Steam Proton data, restore it, remove retained originals, or write Lutris definitions. | 7 | External opt-in |
