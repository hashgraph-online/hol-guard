...
from .command_synapsectrl_extensions import SYNAPSECTRL_COMMAND_EXTENSION_SPECS, SYNAPSECTRL_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (SYNAPSECTRL_COMMAND_EXTENSION_SPECS, SYNAPSECTRL_COMMAND_RULES),
)
