...
TEST_INVARIANTS: Final[tuple[TestInvariant, ...]] = (
    ...
    TestInvariant(
        "GUARD-INV-003",
        "tests/test_guard_runtime_044_guard_runtime_tool_action_policy_does_not.py::test_guard_hook_codex_post_tool_use_blocks_credential_looking_output",
        "hook-output",
    ...
    TestInvariant(
        "GUARD-INV-004",
        "tests/test_guard_runtime_046_codex_browser_approval_decision_updates_daemon_operation.py::test_guard_hook_codex_post_tool_use_blocks_named_secret_output",
        "hook-output",
    ...
    TestInvariant(
        "GUARD-INV-005",
        "tests/test_guard_runtime_044_guard_runtime_tool_action_policy_does_not.py::test_guard_hook_codex_user_prompt_submit_guard_bypass_hard_blocks_without_approval_url",
        "hook-policy",
    ...
    TestInvariant(
        "GUARD-INV-006",
        "tests/test_guard_runtime_037_runtime_hook_package_without_workspace_invalidates_allow.py::test_guard_hook_saved_artifact_approval_never_lowers_current_payload_block",
        "approval",
    ...
    TestInvariant(
        "GUARD-INV-007",
        "tests/test_guard_runtime_024_guard_hook_claude_ask_user_question_unsigned.py::test_guard_hook_claude_alias_saved_allow_does_not_lower_canonical_reapproval",
        "approval",
    ...
    TestInvariant(
        "GUARD-INV-008",
        "tests/test_guard_runtime_051_sync_receipts_preserves_batch_metadata_and_reuses.py::test_policy_bundle_validation_rejects_tampered_hash",
        "managed-policy",
    ...
    TestInvariant(
        "GUARD-INV-009",
        "tests/test_guard_runtime_055_simulate_policy_bundle_receipts_replays_recent_receipts.py::test_cached_policy_bundle_revalidation_rejects_expired_last_known_good",
        "managed-policy",
