...
| `command.kim` | Reviews kim commands that mutate the local reminder config or stop the reminder daemon; read-only inspection stays automatic. | 4 | External opt-in |
