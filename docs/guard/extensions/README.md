...
| `command.codesage` | Reviews CodeSage hook installation and MCP registration changes. Doctor, status, and search do not require review from this extension. | 3 | External opt-in |
