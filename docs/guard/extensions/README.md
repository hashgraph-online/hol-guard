...
| `command.shellroute` | Reviews shellroute routed command execution, persistent proxy start and stop, and API key reveal while leaving status, balance, and country listings automatic. | 3 | External opt-in |
