...
from .command_dotnet_extensions import DOTNET_COMMAND_EXTENSION_SPECS, DOTNET_COMMAND_RULES
from .command_extension_specs import CommandExtensionValues, command_extension_values
from .command_first_class_cli_extensions import (
...
from .command_package_publication_extensions import (
...
from .command_release32_boundary_expansions import RELEASE32_DATABASE_EXPANSION_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (DATABASE_COMMAND_EXTENSION_SPECS, (*DATABASE_COMMAND_RULES, *RELEASE32_DATABASE_EXPANSION_RULES)),
    ...
    (DOTNET_COMMAND_EXTENSION_SPECS, DOTNET_COMMAND_RULES),
    (PACKAGE_PUBLICATION_COMMAND_EXTENSION_SPECS, PACKAGE_PUBLICATION_COMMAND_RULES),
    (FIRST_CLASS_CLI_COMMAND_EXTENSION_SPECS, FIRST_CLASS_CLI_COMMAND_RULES),
)
