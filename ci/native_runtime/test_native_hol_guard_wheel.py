...
def test_adapter_session_stops_before_broadcasting_worker_client_close(
    ...
    monkeypatch.setattr(
        ...
        lambda _runtime, _guard_home, **_kwargs: events.append("stop") or True,
    )
...
def test_adapter_session_keeps_containment_when_worker_client_cleanup_fails(
    ...
    monkeypatch.setattr(native_slo_session, "stop_native_resident", lambda *_args, **_kwargs: contained)
