...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sqlite3 app.db .restore backup.db", "SQLite destructive command", "command.database.sqlite.restore"),
        ("sqlite3.cmd .restore backup.db", "SQLite destructive command", "command.database.sqlite.restore"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "supabase db reset --linked --dry-run",
