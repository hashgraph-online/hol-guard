...
| `command.gsc` | Reviews Google Search Console commands that submit indexing requests, notify removals, submit sitemaps, or purge local search performance cache. | 5 | External opt-in |
