...
pub const NATIVE_RESIDENT_LIFECYCLE_ERROR_CODES: &[&str] = &[
    ...
    "native_workspace_review_authority_generation_invalid",
    ...
    "native_workspace_review_decision_authority_mismatch",
    "native_workspace_review_decision_binding_invalid",
