...
def test_action_metadata_includes_marketplace_branding_and_fallback_install() -> None:
    ...
    assert 'CISCO_RELEASE_URL="https://github.com/cisco-ai-defense/skill-scanner/archive/refs/tags/2.0.8.tar.gz"' in action_text
    assert 'pip install "$CISCO_RELEASE_URL"' in action_text
...
def test_action_bundle_docs_live_in_action_readme() -> None:
    ...
    assert "official Cisco skill-scanner release used by this repo" in action_readme
