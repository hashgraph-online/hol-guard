...
from .command_agentbridge_extensions import AGENTBRIDGE_COMMAND_EXTENSION_SPECS, AGENTBRIDGE_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (AGENTBRIDGE_COMMAND_EXTENSION_SPECS, AGENTBRIDGE_COMMAND_RULES),
)
