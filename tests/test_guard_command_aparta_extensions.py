...
APARTA_REVIEW_CASES: tuple[tuple[str, str, str], ...] = (
    ...
    ("aparta init", _WRITE_ACTION, _WRITE_RULE),
    ("aparta --verbose init", _WRITE_ACTION, _WRITE_RULE),
    ("aparta add gcloud", _WRITE_ACTION, _WRITE_RULE),
    ("aparta add client-api gcloud", _WRITE_ACTION, _WRITE_RULE),
    ("aparta doctor --fix", _WRITE_ACTION, _WRITE_RULE),
    ("aparta doctor -f client-a", _WRITE_ACTION, _WRITE_RULE),
    ("aparta doctor client-a --fix", _WRITE_ACTION, _WRITE_RULE),
    ("aparta shell-install", _WRITE_ACTION, _WRITE_RULE),
...
APARTA_SAFE_COMMANDS: tuple[str, ...] = (
    ...
    "aparta --dry-run init",
    "aparta init --dry-run",
    "aparta --dry-run add gcloud",
    "aparta add client-api gcloud --dry-run",
    "aparta --dry-run doctor --fix",
    "aparta doctor --fix --dry-run client-a",
    "aparta --dry-run shell-install",
    "aparta init --help",
    "aparta add --help",
    "aparta doctor --help",
    "aparta doctor --fix --help",
    "aparta shell-install --help",
    "aparta update",
    "aparta update --help",
    "aparta apply --help",
    "aparta apply -h",
