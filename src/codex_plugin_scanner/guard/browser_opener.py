...
def open_browser_url(url: str) -> bool:
    ...
    Linux environments without a graphical session cannot open the dashboard.
    With a graphical session, delegate browser selection to the desktop's
    generic handler. A Chromium-specific userns probe would incorrectly block
