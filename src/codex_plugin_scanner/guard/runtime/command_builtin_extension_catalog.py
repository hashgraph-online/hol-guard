...
from .command_promptbranch_extensions import PROMPTBRANCH_COMMAND_EXTENSION_SPECS, PROMPTBRANCH_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (PROMPTBRANCH_COMMAND_EXTENSION_SPECS, PROMPTBRANCH_COMMAND_RULES),
