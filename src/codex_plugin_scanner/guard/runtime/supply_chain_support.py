...
_SUPPORT_LEVELS: dict[str, tuple[str, str, str]] = {
    ...
    "homebrew": ("Homebrew formulae", "monitor-only", "Monitor-only"),
    "homebrew-cask": ("Homebrew Casks", "monitor-only", "Monitor-only"),
    "homebrew-tap": ("Homebrew taps", "monitor-only", "Monitor-only"),
