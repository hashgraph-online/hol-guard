...
| `command.gorgona` | Reviews Gorgona time-locked messaging operations that mutate local key material, send or revoke encrypted messages, or execute decrypted messages as system commands. | 4 | External opt-in |
