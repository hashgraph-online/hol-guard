...
from .command_aether_vault_extensions import AETHER_VAULT_COMMAND_EXTENSION_SPECS, AETHER_VAULT_COMMAND_RULES
...
_DIRECT_EXTENSION_CATALOGS = (
    ...
    (AETHER_VAULT_COMMAND_EXTENSION_SPECS, AETHER_VAULT_COMMAND_RULES),
)
